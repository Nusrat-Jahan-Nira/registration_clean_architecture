              ...
              children: [
                ...
                Consumer<RegisterProvider>(
                    ...
                    return ElevatedButton(
                      onPressed: () async {
                          await provider.getRegistration(
                            _usernameController.text,
                            _emailController.text,
                            _passwordController.text,
                          );
                          ...
                          if (provider.errorMessage != null) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(content: Text(provider.errorMessage.toString())),
                            );

                          } else if (provider.resData != null) {

                            ScaffoldMessenger.of(context).showSnackBar(
                               SnackBar(content: Text('Registration Successful! Data:  ${provider.resData?.username.toString()}'))
                            );
